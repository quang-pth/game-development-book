...
MrCircuit::MrCircuit(Game* game, const std::string& name) :
	Enemy(game, name),
	mPatrolDuration(2.5f), mCurrentPatrolTime(2.5f)
{
	...
	pTransform->SetPosition(Vector2(128.0f, 128.0f));
	...
	*/
	...
	std::vector<SDL_Texture*> runningTextures = {
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Running/tile000.png"),
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Running/tile001.png"),
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Running/tile002.png"),
	};
	...
	std::vector<SDL_Texture*> idleTextures = {
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Idle/tile000.png"),
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Idle/tile001.png"),
	};
	...
	std::vector<SDL_Texture*> hurtTextures = {
		game->GetTexture("Assets/Shooter/Enemy/MrCircuit/Hurt/tile000.png"),
	};
...
void MrCircuit::Patrol(float deltaTime)
{
...
void MrCircuit::Death(float deltaTime)
{
}

void MrCircuit::ConstraintInBounds()
{
}

void MrCircuit::ChangeDirection()
{
